...
from .modules import batch, cancel, botfiles, copy, leech, mirror_leech, myfilesset, owner_settings, cloudselect, myfiles, stats, status, clone, storage, cleanup, user_settings, ytdlp, shell, exec, bt_select, rss,  sync
...
async def start(client, message):
    ...
    if await CustomFilters.user_filter(client, message) or CustomFilters.chat_filter(client, message):
        msg = '''
